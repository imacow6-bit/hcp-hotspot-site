            ...
            {zoomLevel < 5.5 ? (
              <>
                ...
                <div className="onboarding-description">
                  <p>I pulled about 71,000 doctors from 2 databases to make this map. The first database is the NPI registry, which is basically a phone book for every licensed prescriber and the second data base is the CMS Open Payments database, which logs every dollar pharma companies pay to physicians.</p>
