            ...
            {zoomLevel < 5.5 ? (
              <>
                ...
                <div className="onboarding-description">
                  ...
                  <p><span style={{ color: "#00e5ff" }}>This map may have the greatest application for rural or suburban areas where a clustering of doctors is not so obvious.</span> Draw a circle around a group of doctors and it will tell you the closest geographical midpoint between all of them. Along the top of the page, you can filter doctors by 6 specialties.</p>
                </div>
              </>
            ) : (
              <>
